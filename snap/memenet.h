...
//
// Note (Pierre): This file is not included anywhere, and contains errors. Is
// it deprecated?
//
...
public:
  ...
  TChA GetWebsite(const int& UrlId) const { return TStrUtil::GetWebsite(UrlH.GetKey(UrlId)); } // FIXME: no member named 'GetWebsite' in 'TStrUtil'; did you mean 'GetWebsiteNm'?
